 ...
 */            !function(e, t) {
                "use strict";
                true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = t, __WEBPACK_AMD_DEFINE_RESULT__ = typeof __WEBPACK_AMD_DEFINE_FACTORY__ === "function" ? __WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module) : __WEBPACK_AMD_DEFINE_FACTORY__, 
                ...
                var r, l, u, c, d, f = '<svg width="44" height="60"><polyline points="30 10 10 30 30 50" stroke="rgba(255,255,255,0.5)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>', g = '<svg width="44" height="60"><polyline points="14 10 34 30 14 50" stroke="rgba(255,255,255,0.5)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>', p = '<svg width="30" height="30"><g stroke="rgb(160,160,160)" stroke-width="4"><line x1="5" y1="5" x2="25" y2="25"/><line x1="5" y1="25" x2="25" y2="5"/></g></svg>', b = {}, v = {
                    ...
                    i.count++, 1 < i.count && (i.multitouch = !0), i.startX = e.changedTouches[0].pageX, 
                ...
                function H(e, t) {
                    if (h !== e) {
                        ...
                        for (var n, o = [], i = [], a = k.length = 0; a < e.length; a++) (n = J("div")).className = "full-image", 
                        n.id = "baguette-img-" + a, k.push(n), o.push("baguetteBox-figure-" + a), i.push("baguetteBox-figcaption-" + a), 
                        l.appendChild(k[a]);
                ...
                function I(e) {
                    ...
                    "block" !== r.style.display && (U(document, "keydown", F), i = {
                        count: 0,
                        startX: null,
                        startY: null
                    }, q(o = e, (function() {
                        ...
                        r.className = "visible", b.bodyClass && document.body.classList && document.body.classList.add(b.bodyClass), 
                        b.afterShow && b.afterShow();
                    }), 50), b.onChange && b.onChange(o, k.length), s = document.activeElement, Y(), 
                    n = !0);
                }
                function Y() {
                ...
                function j() {
                    ...
                    "none" !== r.style.display && (W(document, "keydown", F), r.className = "", setTimeout((function() {
                        ...
                        b.afterHide && b.afterHide(), s && s.focus(), n = !1;
                    }), 500));
                }
                function q(t, n) {
                    var e = k[t], o = h[t];
                    if (void 0 !== e && void 0 !== o) if (e.getElementsByTagName("img")[0]) n && n(); else {
                        var i = o.imageElement, a = i.getElementsByTagName("img")[0], s = "function" == typeof b.captions ? b.captions.call(h, i) : i.getAttribute("data-caption") || i.title, r = function d(e) {
                            var t = e.href;
                            if (e.dataset) {
                                var n = [];
                        ...
                        }, c.setAttribute("src", r), c.alt = a && a.alt || "", b.titleTag && s && (c.title = s), 
                        l.appendChild(c), b.async && n && n();
                    }
                }
                function X() {
                    return M(o + 1);
                ...
                function M(e, t) {
                    return !n && 0 <= e && e < t.length ? (H(t, b), I(e), !0) : e < 0 ? (b.animation && O("left"), 
                    !1) : e >= k.length ? (b.animation && O("right"), !1) : (q(o = e, (function() {
                        z(o), V(o);
                ...
                return [].forEach || (Array.prototype.forEach = function(e, t) {
                    ...
                    run: function K(e, t) {
                        return m.transforms = function n() {
                            ...
                            if (r = G("baguetteBox-overlay")) return l = G("baguetteBox-slider"), u = G("previous-button"), 
                            c = G("next-button"), void (d = G("close-button"));
                            (r = J("div")).setAttribute("role", "dialog"), r.id = "baguetteBox-overlay", document.getElementsByTagName("body")[0].appendChild(r), 
                            (l = J("div")).id = "baguetteBox-slider", r.appendChild(l), (u = J("button")).setAttribute("type", "button"), 
                            u.id = "previous-button", u.setAttribute("aria-label", "Previous"), u.innerHTML = m.svg ? f : "&lt;", 
                            r.appendChild(u), (c = J("button")).setAttribute("type", "button"), c.id = "next-button", 
                            c.setAttribute("aria-label", "Next"), c.innerHTML = m.svg ? g : "&gt;", r.appendChild(c), 
                            (d = J("button")).setAttribute("type", "button"), d.id = "close-button", d.setAttribute("aria-label", "Close"), 
                            d.innerHTML = m.svg ? p : "&times;", r.appendChild(d), u.className = c.className = d.className = "baguetteBox-button", 
                            function n() {
                                ...
                                U(r, "click", x), U(u, "click", E), U(c, "click", C), U(d, "click", B), U(l, "contextmenu", A), 
                                U(r, "touchstart", T, t), U(r, "touchmove", N, e), U(r, "touchend", L), U(document, "focus", P, !0);
                            }();
                        }(), S(e), function s(e, a) {
                    ...
                    destroy: function e() {
                        !function n() {
                            ...
                            W(r, "click", x), W(u, "click", E), W(c, "click", C), W(d, "click", B), W(l, "contextmenu", A), 
                            W(r, "touchstart", T, t), W(r, "touchmove", N, e), W(r, "touchend", L), W(document, "focus", P, !0);
                        }(), function t() {
                            for (var e in w) w.hasOwnProperty(e) && S(e);
                        }(), W(document, "keydown", F), document.getElementsByTagName("body")[0].removeChild(document.getElementById("baguetteBox-overlay")), 
                        w = {}, h = [], o = 0;
                    }
                };
            }));
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".services__swiper")) {
                let slides = document.querySelectorAll(".slide-service");
                let slidesCount = Math.floor(slides.length / 2);
                new core(".services__swiper", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 5,
        ...
        if (document.querySelector(".fullpage")) {
            ...
            function setActiveClass() {
                ...
                const slides = document.querySelectorAll(".fullpage__screen");
                const currentClass = slides[pageSlider.realIndex].getAttribute("data-class");
                const headerClass = header.getAttribute("class");
                if (headerClass.split(" ").length > 1) {
                    header.classList.remove(headerClass.split(" ")[1]);
                    header.classList.add(currentClass);
                } else header.classList.add(currentClass);
            }
            pageSlider.init();
        }
        var baguetteBox_min = __webpack_require__(731);
        window.addEventListener("load", (() => {
            baguetteBox_min.run(".portfolio-item", {});
        }));
        ...
        document.addEventListener("click", (e => {
            ...
            if (language) if (target.closest(".language-header__lang")) language.classList.toggle("_active"); else if (target.closest(".language-header__item")) language.classList.remove("_active"); else language.classList.remove("_active");
        }));
        const colors = document.querySelectorAll(".form-brief__color");
        if (colors) {
            let colorCount = 0;
            colors.forEach((color => {
                color.addEventListener("click", (() => {
                    if (color.closest("._selected")) {
                        colorCount -= 1;
                        color.classList.remove("_selected");
                        return;
                    }
                    if (colorCount === 3) return; else {
                        console.log(colorCount);
                        colorCount += 1;
                        color.classList.add("_selected");
                    }
                }));
            }));
        }
